...
@interface PHMomentListViewController ()

@property (strong, nonatomic) UICollectionView *collectionView;

@property (strong, nonatomic) PHMomentListDataSource *dataSource;
@property (nonatomic) BOOL isSelectMode;

@end

@implementation PHMomentListViewController

- (instancetype)init {
    self = [super init];
    if (self) {
        _dataSource = [PHMomentListDataSource new];
