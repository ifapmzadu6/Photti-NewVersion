...
@interface PHPhotoPageViewController () <UIPageViewControllerDataSource, UIPageViewControllerDelegate>
...
@implementation PHPhotoPageViewController
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    PHPhotoViewController *photoViewController = (PHPhotoViewController *)viewController;
...
- (UIViewController *)makePhotoViewController:(NSInteger)index {
    ...
    PHPhotoViewController *viewController = [[PHPhotoViewController alloc] initWithAsset:asset];
