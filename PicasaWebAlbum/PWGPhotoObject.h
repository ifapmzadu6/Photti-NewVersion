...
@property (nonatomic, retain) NSString * originalvideo_channels;
@property (nonatomic, retain) NSString * originalvideo_duration;
@property (nonatomic, retain) NSString * originalvideo_fps;
@property (nonatomic, retain) NSString * originalvideo_height;
@property (nonatomic, retain) NSString * originalvideo_samplingrate;
@property (nonatomic, retain) NSString * originalvideo_type;
@property (nonatomic, retain) NSString * originalvideo_videoCodec;
@property (nonatomic, retain) NSString * originalvideo_width;
