...
- (void)viewDidLoad {
    ...
    [_enableButton addTarget:self action:@selector(accessButtonAction) forControlEvents:UIControlEventTouchUpInside];
    ...
    [_disableButton addTarget:self action:@selector(accessButtonAction) forControlEvents:UIControlEventTouchUpInside];
