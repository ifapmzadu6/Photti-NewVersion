...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.tintColor = [PAColors getColor:kPAColorsTypeTintUploadColor];
    ...
    _createdNewAlbumLabel.textColor = [PAColors getColor:kPAColorsTypeTextLightColor];
    ...
    [_uploadButton setBackgroundImage:[PAIcons imageWithColor:[PAColors getColor:kPAColorsTypeTintUploadColor]] forState:UIControlStateNormal];
    [_uploadButton setTitleColor:[PAColors getColor:kPAColorsTypeBackgroundLightColor] forState:UIControlStateNormal];
    [_uploadButton setTitleColor:[PAColors getColor:kPAColorsTypeTintUploadColor] forState:UIControlStateHighlighted];
    [_uploadButton setBackgroundImage:[PAIcons imageWithColor:[PAColors getColor:kPAColorsTypeTintUploadColor]] forState:UIControlStateNormal];
    [_uploadButton setBackgroundImage:[PAIcons imageWithColor:[PAColors getColor:kPAColorsTypeBackgroundLightColor]] forState:UIControlStateHighlighted];
    _uploadButton.clipsToBounds = YES;
    _uploadButton.layer.cornerRadius = 5.0f;
    _uploadButton.layer.borderColor = [PAColors getColor:kPAColorsTypeTintUploadColor].CGColor;
    ...
    [_skipButton setTitleColor:[PAColors getColor:kPAColorsTypeBackgroundLightColor] forState:UIControlStateHighlighted];
    [_skipButton setTitleColor:[PAColors getColor:kPAColorsTypeTintUploadColor] forState:UIControlStateNormal];
    [_skipButton setBackgroundImage:[PAIcons imageWithColor:[[PAColors getColor:kPAColorsTypeTintUploadColor] colorWithAlphaComponent:0.5f]] forState:UIControlStateHighlighted];
    ...
    [_applyAllItemsButton setTitleColor:[PAColors getColor:kPAColorsTypeBackgroundLightColor] forState:UIControlStateHighlighted];
    [_applyAllItemsButton setTitleColor:[PAColors getColor:kPAColorsTypeTintUploadColor] forState:UIControlStateNormal];
    [_applyAllItemsButton setBackgroundImage:[PAIcons imageWithColor:[[PAColors getColor:kPAColorsTypeTintUploadColor] colorWithAlphaComponent:0.5f]] forState:UIControlStateHighlighted];
...
- (void)uploadButtonAction {
    ...
    uploadImageView.tintColor = [[PAColors getColor:kPAColorsTypeTintUploadColor] colorWithAlphaComponent:0.9f];
